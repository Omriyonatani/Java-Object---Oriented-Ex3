...
//        temp = arr.get(i).getFruitEdge(g,arr.get(i));
//        if ( arr.get(i).getType() == -1) {
//        if(r.getSrc()==temp.getDest()) {
//        arr.remove(i);
//        return temp.getSrc();
//        }
//        else if(r.getSrc()==temp.getSrc()) {
//        arr.remove(i);
//        return temp.getDest();
//        }
//
//        else if (temp.getDest() > temp.getSrc()) {
//
//        disFromRob = p.shortestPathDist(r.getSrc(), temp.getDest());
//        whereTo = temp.getSrc();
//        }
...
//        }
//        List<node_data> ans = p.shortestPath(r.getSrc(), finalWhereTo);
//        arr.remove(fruiToRemove);
//
//        System.out.println("size of arr after delete:" + arr.size());
//        if(ans.size()==1){
//        System.out.println("need to get to " + ans.get(0));
//        return ans.get(0).getKey();
//        }
//        System.out.println("need to get to " + ans.get(1));
//        return ans.get(1).getKey();
//        Graph_Algo p = new Graph_Algo(g);
//        edge_data temp = null;
//        edge_data temp2 = null;
